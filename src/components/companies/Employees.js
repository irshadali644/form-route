...
// const companyNames = mainData.map((item)=>{
//     return item.company
// })
...
//         const currentEmpDetail = mainData.filter((item)=> {
//             if (item.company === currentName) {
//                 return true
//             }
//         })
...
//             <MenuList data={companyNames} fetchData={getDetails} />
